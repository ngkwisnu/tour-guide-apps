...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-[#3F9BB8] p-10">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <a href="/#" className=" inline-block ">
                  ...
                  <img src={Logo} alt="logo" className="w-64 hidden dark:block" />
                </a>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-base text-body-color dark:text-dark-6">&copy; 2025 NusaGuide</p>
              </div>
            </div>
          </div>
        </div>
