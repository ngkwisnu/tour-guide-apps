            ...
            <div className='w-4/5 my-10'>
                <form className="w-full mx-auto" onSubmit={(e) => simpanData(e)}>
                    ...
                    <div className='w-full my-10 justify-center flex'>
                        <button type="submit" className="text-white bg-blue-300 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm w-3/5 px-5 py-2.5 text-center">Tambah Data</button>
                    </div>
                </form>
            </div>
        </div>
