...
Air mineral dan makanan ringan "/>
                    ...
                    <div className='w-full my-20 justify-center flex lg:gap-10 gap-5'>
                        <button type="submit" className="text-black bg-blue-400 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm lg:w-1/5 px-5 py-2.5 text-center">Simpan</button>
                        <Link className='lg:w-1/5 justify-center' to ='/admin'>
                        <button type="button" className="text-black bg-blue-300 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm w-full px-5 py-2.5 text-center">Batal</button>
                        </Link>
                    </div>
                </form>
            </div>
