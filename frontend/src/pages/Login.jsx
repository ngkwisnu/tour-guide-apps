                ...
                <div className='w-full flex flex-col items-center lg:hidden'>
                    <form className="w-4/5 mx-auto">
                        ...
                        <div className="mb-3">
                            ...
                            <Link to = '/change-password'><p className='text-sm text-blue-500 text-right mt-2'>Lupa kata sandi?</p></Link>
                        </div>
                    ...
                    <p className='mt-10'>Belum punya akun? <Link to = '/register'><span className='text-sky-300'>Daftar</span></Link></p>
                </div>
