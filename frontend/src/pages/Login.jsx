...
const Login = () => {
  ...
  const onLogin = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("user", JSON.stringify(data)); // Simpan seluruh objek user
      setCurrentUser(data); // Set currentUser dengan seluruh objek user
    ...
    <>
      <div className="mx-auto lg:flex lg:h-auto">
        ...
        <div className="h-screen lg:h-auto content-center lg:w-2/5 lg:py-16">
          <h1 className="text-2xl text-slate-700 font-semibold text-center mb-5">
            Masuk
          </h1>
            ...
            <form className="w-4/5 mx-auto">
              ...
              <div>
                ...
                <Link href="/change-password">
                  <p className="text-sm text-blue-500 text-right mt-2">
                    Lupa kata sandi?
                  </p>
                </Link>
              </div>
              <div className="flex justify-center lg:mt-8">
                <button
                  type="submit"
                  className="w-1/5 bg-sky-300 rounded-full h-8 text-white font-semibold"
                >
                  Masuk
                </button>
              </div>
