  ...
  return (
    <>
        ...
        >
          ...
          <div className="flex justify-start px-24 h-full w-full items-start pt-8 absolute inset-0 ">
            <div className="max-w-full">
              <h1 className="mb-5 text-8xl text-white font-bold">Explore the sight of the azore</h1>
              <p className="mb-5 text-xl text-white">Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
              <button className="btn text-sm py-2 px-6 bg-white rounded-full btn-primary">Book Now</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <div class="flex items-center justify-center py-10">
        <div class="flex w-full mx-16   rounded-full  border-black border-2">
          <input class=" w-full border-none bg-transparent px-4 py-1 text-black outline-none focus:outline-none " type="search" name="search" placeholder="Masukkan kata kunci..." />
          <button type="submit" class="rounded-full bg-[#3F9BB8] px-6 py-4 text-white">
