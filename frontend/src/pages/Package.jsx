...
const Package = () => {
  ...
  return (
    <>
          ...
          <div className="flex justify-start px-10 md:px-24 top-1/2 left-1/2 -translate-x-2/4 -translate-y-2/4 h-full w-full items-start pt-20 absolute inset-0 ">
            <div className="max-w-full">
              <h1 className="mb-5 md:text-4xl text-2xl text-[#fff] font-bold  ">
                Bali Memanggil{" "}
                <span className="block text-red-500 md:text-7xl text-4xl ">
                  Temukan Surga yang Tak Terlupakan
                </span>
              </h1>
              <p className="mb-5 md:text-xl text-[#fff] ">
                Nikmati keindahan alam, pantai berpasir putih, budaya yang kaya,
                dan petualangan seru di setiap sudut Bali. Bersiaplah untuk
                menciptakan kenangan tak terlupakan di pulau surga ini.
              </p>
              <button className=" text-sm py-2 px-6 bg-white rounded-full  ">
                Pesan Sekarang!
              </button>
            </div>
          </div>
      ...
      <section
        className="relative w-full py-8  px-[5%]  gap-6"
        id="destination"
      >
